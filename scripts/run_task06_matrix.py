...
MAV_METHODS = {
    ...
    "mav_qr_p125_l003_cap003": MethodSpec(
        "mav_qr_p125_l003_cap003",
        "finetune_mv.py",
        (
            "--mv_jepa",
            "--predictors",
    ...
    "mav_qr_p125_l003_cap003_nostrip": MethodSpec(
        "mav_qr_p125_l003_cap003_nostrip",
        "finetune_mv.py",
        (
            "--mv_jepa",
            "--predictors",
    ...
    "mav_rspan_qrpre_rsuf_p125_l003": MethodSpec(
        "mav_rspan_qrpre_rsuf_p125_l003",
        "finetune_mv.py",
        (
            "--view_config",
            "configs/views/gsm8k_rspan.yaml",
            "--mv_jepa",
            "--predictors",
            "0",
            "--lambda_base",
    ...
    "mav_qr_rspan_prior_p125_l003": MethodSpec(
        "mav_qr_rspan_prior_p125_l003",
        "finetune_mv.py",
        (
            "--view_config",
            "configs/views/gsm8k_rspan.yaml",
    ...
    "mav_qr_rspan_answerweak_p125_l003": MethodSpec(
        "mav_qr_rspan_answerweak_p125_l003",
        "finetune_mv.py",
        (
            "--view_config",
            "configs/views/gsm8k_rspan.yaml",
            ...
            "true",
            "--allowed_edges",
            "Q_to_R,QRPRE_to_RSUF,QR_to_A_STMT",
            "--edge_dropout",
            "prior",
            "--edge_budget",
            "1",
    ...
    "mav_qr_full_nostrip_p125_l003_cap003": MethodSpec(
        "mav_qr_full_nostrip_p125_l003_cap003",
        "finetune_mv.py",
        (
            "--view_config",
            "configs/views/gsm8k_r3.yaml",
            "--mv_jepa",
            "--predictors",
            "0",
            "--lambda_base",
    ...
    "mav_qr_maskans_p125_l003_cap003": MethodSpec(
        "mav_qr_maskans_p125_l003_cap003",
        "finetune_mv.py",
        (
            "--view_config",
            "configs/views/gsm8k_r3.yaml",
    ...
    "mav_qr_lastmask_p125_l003_cap003": MethodSpec(
        "mav_qr_lastmask_p125_l003_cap003",
        "finetune_mv.py",
        (
            "--view_config",
            "configs/views/gsm8k_r3.yaml",
    ...
    "mav_qr_maskans_answeak_p125_l003": MethodSpec(
        "mav_qr_maskans_answeak_p125_l003",
        "finetune_mv.py",
        (
            "--view_config",
            "configs/views/gsm8k_r3.yaml",
            ...
            "true",
            "--allowed_edges",
            "Q_to_R_MASKANS,QR_MASKANS_to_A_STMT",
            "--edge_dropout",
            "prior",
            "--edge_budget",
            "1",
            ...
            "--weak_edge_step_prob",
            "0.03",
            "--weak_edge_start_step",
            "3000",
        ),
    ),
    "mav_qr_strip_explicit_p125_l003_cap003": MethodSpec(
        "mav_qr_strip_explicit_p125_l003_cap003",
        "finetune_mv.py",
        (
            "--view_config",
            "configs/views/gsm8k_r3.yaml",
